...
QT_MOC_LITERAL(1, 9, 11), // "stateChange"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "titlebar\0stateChange\0"
};
...
void titlebar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stateChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&titlebar::stateChange)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void titlebar::stateChange(int _t1)
{
