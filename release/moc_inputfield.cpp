...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_inputField_t, stringdata) + ofs \
...
const QMetaObject inputField::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_inputField.data,
      qt_meta_data_inputField,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *inputField::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_inputField.stringdata))
