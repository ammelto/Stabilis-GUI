...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sidemenu_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_sidemenu_t qt_meta_stringdata_sidemenu = {
    {
QT_MOC_LITERAL(0, 0, 8), // "sidemenu"
QT_MOC_LITERAL(1, 9, 10), // "setDisplay"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "sidemenu\0setDisplay\0"
};
...
void sidemenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setDisplay((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (sidemenu::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sidemenu::setDisplay)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject sidemenu::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sidemenu.data,
      qt_meta_data_sidemenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *sidemenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sidemenu.stringdata))
        return static_cast<void*>(const_cast< sidemenu*>(this));
...
// SIGNAL 0
void sidemenu::setDisplay(int _t1)
{
