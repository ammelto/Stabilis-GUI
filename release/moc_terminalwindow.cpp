...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TerminalWindow_t, stringdata) + ofs \
...
const QMetaObject TerminalWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TerminalWindow.data,
...
void *TerminalWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TerminalWindow.stringdata))
